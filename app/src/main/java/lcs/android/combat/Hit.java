...
public class Hit {
  ...
  private Set<Wound> mDamageType = EnumSet.noneOf(Wound.class);
  ...
  @Getter Set<Wound> damageType() {
    return mDamageType;
  }

  @Setter Hit damageType(final Set<Wound> attackWounds) {
